...
const TYPE_LABELS: Record<Locale, Record<KnowledgeBundleType, string>> = {
  en: { concept: 'Concept', procedure: 'Procedure', comparison: 'Comparison', mechanism: 'Mechanism', structure: 'Structure', claim_evidence: 'Claim & evidence', question: 'Question', decision: 'Decision', event: 'Event' },
  ja: { concept: '概念', procedure: '手順', comparison: '比較', mechanism: '仕組み', structure: '構造', claim_evidence: '主張と根拠', question: '質問', decision: '決定', event: '出来事' },
  'zh-CN': { concept: '概念', procedure: '步骤', comparison: '比较', mechanism: '机制', structure: '结构', claim_evidence: '主张与证据', question: '问题', decision: '决策', event: '事件' },
  es: { concept: 'Concepto', procedure: 'Procedimiento', comparison: 'Comparación', mechanism: 'Mecanismo', structure: 'Estructura', claim_evidence: 'Afirmación y evidencia', question: 'Pregunta', decision: 'Decisión', event: 'Evento' },
  ar: { concept: 'مفهوم', procedure: 'إجراء', comparison: 'مقارنة', mechanism: 'آلية', structure: 'بنية', claim_evidence: 'ادعاء ودليل', question: 'سؤال', decision: 'قرار', event: 'حدث' },
  hi: { concept: 'अवधारणा', procedure: 'प्रक्रिया', comparison: 'तुलना', mechanism: 'तंत्र', structure: 'संरचना', claim_evidence: 'दावा और प्रमाण', question: 'प्रश्न', decision: 'निर्णय', event: 'घटना' },
};
...
export function buildMobileKnowledgeBundle(type: KnowledgeBundleType, fields: string[]): KnowledgeBundleContent {
  const [one = '', two = '', three = '', four = '', five = '', six = '', seven = ''] = fields;
  ...
  if (type === 'event') return { type, event: one.trim(), occurred_at: two.trim(), context: three.trim(), changes: lines(four), causes: lines(five), consequences: lines(six) };
