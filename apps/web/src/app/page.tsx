        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(20rem,0.55fr)] lg:items-end">
          <div className="fade-up max-w-3xl">
            ...
            {user && userStats ? (
              ...
              >
                <StatBox value={userStats.known} label="Known" color="text-emerald-200" bg="bg-emerald-400/10 border-emerald-300/20" />
                <StatBox value={userStats.saved} label="Saved" color="text-sky-200" bg="bg-sky-400/10 border-sky-300/20" />
                <StatBox value={userKnowledgeItems.length} label="Notes" color="text-amber-200" bg="bg-amber-400/10 border-amber-300/20" />
              </div>
            ) : null}
          </div>
          ...
          <div className="fade-up grid gap-3 lg:pb-4">
            <div className="rounded-lg border border-white/15 bg-white/10 p-4 backdrop-blur">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-200">
                The homepage scene shifts with your known cards, saved queue, and private notes.
              </p>
            </div>
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
              <Feature title="Adaptive practice" description="Mark what is unclear and only promote concepts you can explain." tone="border-emerald-300/20 bg-emerald-400/10" />
              <Feature title="Review queue" description="Keep weak concepts in a focused queue until they feel stable." tone="border-sky-300/20 bg-sky-400/10" />
              <Feature title="Knowledge vault" description="Write and manage your own private notes and frameworks." tone="border-amber-300/20 bg-amber-400/10" />
            </div>
          </div>
        </div>
...
function StatBox({
  ...
  return (
    <div className={`rounded-lg border px-3 py-2 text-center backdrop-blur ${bg}`}>
...
function Feature({
  ...
  return (
    <div className={`rounded-lg border p-4 backdrop-blur ${tone}`}>
      <div>
