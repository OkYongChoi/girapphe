/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.worker-types.env --env-interface=CloudflareEnv` (hash: c1820efe68c69e964fdb7d6e5c1bf575)
// Runtime types generated with workerd@1.20260820.1 2026-08-16 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	AI: Ai;
	ASSETS: Fetcher;
	APP_ENV: "preview" | "prod" | "base";
	AI_THINKING_HISTORY_ROLLOUT: "all" | "allowlist" | "off";
	RECALL_RUNTIME_ROLLOUT: "allowlist" | "off";
}
declare namespace Cloudflare {
	interface PreviewEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "preview";
		AI_THINKING_HISTORY_ROLLOUT: "all";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "AI_THINKING_HISTORY_ROLLOUT" | "RECALL_RUNTIME_ROLLOUT">> {}
}
