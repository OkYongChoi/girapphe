...
export const GRAPH_EDGES: GraphEdge[] = [
  ...
  { source: 'engineering_science', target: 'mechanics_materials', type: 'generalizes', weight: 1.0 },
  { source: 'engineering_science', target: 'fluid_mechanics', type: 'generalizes', weight: 1.0 },
  { source: 'engineering_science', target: 'heat_transfer', type: 'generalizes', weight: 1.0 },
  { source: 'engineering_science', target: 'circuits_electromagnetics', type: 'generalizes', weight: 1.0 },
  { source: 'engineering_science', target: 'semiconductor_devices', type: 'generalizes', weight: 1.0 },
  { source: 'engineering_science', target: 'plasma_mhd', type: 'generalizes', weight: 1.0 },
  { source: 'engineering_science', target: 'transport_control', type: 'generalizes', weight: 1.0 },
  { source: 'engineering_science', target: 'engineering_scaling', type: 'generalizes', weight: 1.0 },

  { source: 'mechanics_materials', target: 'normal_stress', type: 'generalizes', weight: 0.9 },
  { source: 'mechanics_materials', target: 'engineering_strain', type: 'generalizes', weight: 0.9 },
  { source: 'mechanics_materials', target: 'hookes_law', type: 'generalizes', weight: 0.9 },
  { source: 'mechanics_materials', target: 'shear_stress_strain', type: 'generalizes', weight: 0.9 },
  { source: 'normal_stress', target: 'hookes_law', type: 'prerequisite', weight: 0.8 },
  { source: 'engineering_strain', target: 'hookes_law', type: 'prerequisite', weight: 0.8 },

  { source: 'fluid_mechanics', target: 'continuity_equation_fluids', type: 'generalizes', weight: 0.9 },
  { source: 'fluid_mechanics', target: 'bernoulli_equation', type: 'generalizes', weight: 0.9 },
  { source: 'fluid_mechanics', target: 'hydrostatic_pressure_gradient', type: 'generalizes', weight: 0.8 },
  { source: 'fluid_mechanics', target: 'navier_stokes_equation', type: 'generalizes', weight: 0.9 },
  { source: 'fluid_mechanics', target: 'poiseuille_law', type: 'generalizes', weight: 0.8 },
  { source: 'fluid_mechanics', target: 'darcy_weisbach_equation', type: 'generalizes', weight: 0.8 },
  { source: 'fluid_mechanics', target: 'drag_equation', type: 'generalizes', weight: 0.8 },
  { source: 'fluid_mechanics', target: 'reynolds_number', type: 'generalizes', weight: 0.9 },
  { source: 'continuity_equation_fluids', target: 'bernoulli_equation', type: 'prerequisite', weight: 0.7 },
  { source: 'navier_stokes_equation', target: 'poiseuille_law', type: 'derived_from', weight: 0.7 },
  { source: 'navier_stokes_equation', target: 'darcy_weisbach_equation', type: 'derived_from', weight: 0.6 },
  { source: 'reynolds_number', target: 'poiseuille_law', type: 'prerequisite', weight: 0.8 },
  { source: 'reynolds_number', target: 'darcy_weisbach_equation', type: 'prerequisite', weight: 0.8 },
  { source: 'reynolds_number', target: 'drag_equation', type: 'related', weight: 0.7 },
  { source: 'reynolds_number', target: 'engineering_scaling', type: 'related', weight: 0.8 },

  { source: 'heat_transfer', target: 'fourier_heat_conduction', type: 'generalizes', weight: 0.9 },
  { source: 'heat_transfer', target: 'newton_cooling_law', type: 'generalizes', weight: 0.9 },
  { source: 'heat_transfer', target: 'thermal_radiation_law', type: 'generalizes', weight: 0.8 },
  { source: 'heat_transfer', target: 'thermal_resistance_network', type: 'generalizes', weight: 0.9 },
  { source: 'heat_transfer', target: 'heat_equation', type: 'generalizes', weight: 0.9 },
  { source: 'heat_transfer', target: 'nusselt_number', type: 'generalizes', weight: 0.8 },
  { source: 'heat_transfer', target: 'prandtl_number', type: 'generalizes', weight: 0.8 },
  { source: 'fourier_heat_conduction', target: 'heat_equation', type: 'derived_from', weight: 0.8 },
  { source: 'fourier_heat_conduction', target: 'thermal_resistance_network', type: 'derived_from', weight: 0.8 },
  { source: 'newton_cooling_law', target: 'thermal_resistance_network', type: 'derived_from', weight: 0.8 },
  { source: 'nusselt_number', target: 'newton_cooling_law', type: 'prerequisite', weight: 0.7 },
  { source: 'prandtl_number', target: 'nusselt_number', type: 'prerequisite', weight: 0.7 },
  { source: 'nusselt_number', target: 'engineering_scaling', type: 'related', weight: 0.7 },
  { source: 'prandtl_number', target: 'engineering_scaling', type: 'related', weight: 0.7 },

  { source: 'circuits_electromagnetics', target: 'current_density_ohm_law', type: 'generalizes', weight: 0.9 },
  { source: 'circuits_electromagnetics', target: 'capacitor_charge_law', type: 'generalizes', weight: 0.8 },
  { source: 'circuits_electromagnetics', target: 'capacitor_current_law', type: 'generalizes', weight: 0.8 },
  { source: 'circuits_electromagnetics', target: 'inductor_voltage_law', type: 'generalizes', weight: 0.8 },
  { source: 'circuits_electromagnetics', target: 'rc_time_constant', type: 'generalizes', weight: 0.9 },
  { source: 'capacitor_charge_law', target: 'capacitor_current_law', type: 'prerequisite', weight: 0.8 },
  { source: 'capacitor_charge_law', target: 'rc_time_constant', type: 'prerequisite', weight: 0.8 },

  { source: 'semiconductor_devices', target: 'semiconductor_drift_current', type: 'generalizes', weight: 0.9 },
  { source: 'semiconductor_devices', target: 'semiconductor_diffusion_current', type: 'generalizes', weight: 0.9 },
  { source: 'semiconductor_devices', target: 'einstein_relation_semiconductors', type: 'generalizes', weight: 0.8 },
  { source: 'semiconductor_devices', target: 'semiconductor_conductivity', type: 'generalizes', weight: 0.8 },
  { source: 'semiconductor_devices', target: 'diode_equation', type: 'generalizes', weight: 0.9 },
  { source: 'semiconductor_devices', target: 'cmos_dynamic_power', type: 'generalizes', weight: 0.9 },
  { source: 'current_density_ohm_law', target: 'semiconductor_conductivity', type: 'related', weight: 0.7 },
  { source: 'semiconductor_drift_current', target: 'semiconductor_conductivity', type: 'derived_from', weight: 0.8 },
  { source: 'semiconductor_drift_current', target: 'diode_equation', type: 'prerequisite', weight: 0.7 },
  { source: 'semiconductor_diffusion_current', target: 'diode_equation', type: 'prerequisite', weight: 0.8 },
  { source: 'einstein_relation_semiconductors', target: 'semiconductor_diffusion_current', type: 'related', weight: 0.7 },
  { source: 'capacitor_charge_law', target: 'cmos_dynamic_power', type: 'prerequisite', weight: 0.8 },

  { source: 'plasma_mhd', target: 'debye_length', type: 'generalizes', weight: 0.9 },
  { source: 'plasma_mhd', target: 'plasma_frequency', type: 'generalizes', weight: 0.9 },
  { source: 'plasma_mhd', target: 'larmor_radius', type: 'generalizes', weight: 0.9 },
  { source: 'plasma_mhd', target: 'alfven_speed', type: 'generalizes', weight: 0.9 },
  { source: 'plasma_mhd', target: 'plasma_beta', type: 'generalizes', weight: 0.9 },
  { source: 'plasma_mhd', target: 'magnetic_reynolds_number', type: 'generalizes', weight: 0.9 },
  { source: 'larmor_radius', target: 'plasma_beta', type: 'related', weight: 0.5 },
  { source: 'alfven_speed', target: 'plasma_beta', type: 'related', weight: 0.7 },
  { source: 'magnetic_reynolds_number', target: 'engineering_scaling', type: 'related', weight: 0.8 },
  { source: 'plasma_beta', target: 'engineering_scaling', type: 'related', weight: 0.8 },

  { source: 'transport_control', target: 'fick_law', type: 'generalizes', weight: 0.9 },
  { source: 'transport_control', target: 'advection_diffusion_equation', type: 'generalizes', weight: 0.9 },
  { source: 'transport_control', target: 'material_derivative', type: 'generalizes', weight: 0.8 },
  { source: 'transport_control', target: 'first_order_transfer_function', type: 'generalizes', weight: 0.8 },
  { source: 'fick_law', target: 'advection_diffusion_equation', type: 'prerequisite', weight: 0.8 },
  { source: 'material_derivative', target: 'navier_stokes_equation', type: 'prerequisite', weight: 0.7 },
  { source: 'material_derivative', target: 'advection_diffusion_equation', type: 'prerequisite', weight: 0.7 },
  { source: 'rc_time_constant', target: 'first_order_transfer_function', type: 'related', weight: 0.7 },
  { source: 'heat_equation', target: 'first_order_transfer_function', type: 'related', weight: 0.5 },
