...
knowledge inaccessible. Keep migration `0023`'s telemetry compatibility
triggers through the old-Worker drain window; contracting them is a separate
post-rollout change.
