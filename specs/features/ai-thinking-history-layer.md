...
| Criterion | Evidence |
| --- | --- |
| `AC-01` | Planned parser fixture tests for supported/unsupported exports plus a browser test proving local preview and zero pre-consent processing requests. |
| `AC-02` | Planned retention and telemetry tests inspect success, cancel, timeout, failure, logging, tracing, and account-deletion paths; browser/network evidence proves raw input is absent. |
...
| `AC-12` | Planned adversarial tests cover archive/request limits, duplicate/idempotent submissions, partial retries, quotas, cost ceilings, and cross-owner access. |
