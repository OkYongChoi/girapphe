...
export const DOMAIN_COLORS: Record<string, string> = {
  ...
  'operating_systems': '#14b8a6',
  'computer_networks': '#0f766e',
  databases: '#0ea5a5',
  distributed_systems: '#0f766e',
  systems_performance: '#0ea5e9',
  security: '#ef4444',
  software_engineering: '#8b5cf6',
  programming_languages: '#f97316',
